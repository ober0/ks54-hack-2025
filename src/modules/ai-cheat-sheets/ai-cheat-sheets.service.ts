        ...
        const messages = [
            {
                role: 'developer',
                content:
                    'Твоя задача изучить файлы и описание если они есть и на основе их выдать краткую но емкую информацией шпоргалку для студента в тексстовом формате, с MD разметкой. В математических формулах Markdown пиши ТОЛЬКО корректные формулы в LaTeX-синтаксисе. Используй двойные долларовые знаки для блочных формул и одинарные для встроенных, без лишнего текста или символов.'
            },
            {
                role: 'user',

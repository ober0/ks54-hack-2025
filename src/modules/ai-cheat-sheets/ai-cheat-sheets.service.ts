...
export class AiCheatSheetsService {
    ...
    async processCheatSheet(dto: AiCheatSheetDto, files: Express.Multer.File[], jwtPayload: JwtPayloadDto) {
        ...
        const messages = [
            {
                role: 'developer',
                content: 'Твоя задача изучить файлы и описание если они есть и на основе их выдать краткую но емкую информацией шпоргалку для студента в тексстовом формате, с MD разметкой'
            },
            {
                role: 'user',
